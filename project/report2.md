...
| Trial        | Samples | Duration (s) | Mean Δt (s) | Std Δt (s) | Min Δt (s) | Max Δt (s) | Mean Δp (m) | Std Δp (m) | Max Δp (m) | Std X (m) | Std Y (m) | Mean Radial (m) | Max Radial (m) | Std θ (deg) | Mean Abs Δθ (deg) | Max Abs Δθ (deg) | σₓ (m) | σᵧ (m) | σθ (deg) |
|--------------|---------|--------------|-------------|------------|------------|------------|-------------|------------|------------|-----------|-----------|-----------------|-----------------|-------------|--------------------|-------------------|--------|--------|----------|
