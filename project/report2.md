...
![RQT Graph]({{ '/assets/images/turtlebot.png' | relative_url }})
...
| Trial       | Samples | Duration (s) | Mean Δt (s) | Std Δt (s) | Min Δt (s) | Max Δt (s) | Mean Δp (m) | Std Δp (m) | Max Δp (m) | Std X (m) | Std Y (m) | Mean Radial (m) | Max Radial (m) | Std θ (deg) | Mean Abs Δθ (deg) | Max Abs Δθ (deg) | σx (m) | σy (m) | σθ (deg) |
|-------------|---------|--------------|-------------|------------|------------|------------|-------------|------------|------------|-----------|-----------|-----------------|-----------------|-------------|--------------------|-------------------|--------|--------|----------|
...
|--------------------|------------------------------|------------------------|-------------------------------------------|
| Sean Vellequette | System Integration, Audio Systems & Analysis Tools | [6aaae2c](https://github.com/GSandys7/PacManBot_ROS2/commit/6aaae2c9b900b834767b17d1c5288fc11e4e71ac), [d9b96e7](https://github.com/GSandys7/PacManBot_ROS2/commit/d9b96e79c792f814de994bf2b7fcbcecaf6d4401) | [audio_node.py](https://github.com/GSandys7/PacManBot_ROS2/blob/main/pacmanbot_package/pacmanbot_package/audio_node.py), [pacmanbot_analysis](https://github.com/GSandys7/PacManBot_ROS2/tree/main/pacmanbot_package/pacmanbot_analysis) |
| Gabriel Sandys | Autonomous Planning & Game State Systems | [5683d60](https://github.com/GSandys7/PacManBot_ROS2/commit/5683d60), [661bb9a](https://github.com/GSandys7/PacManBot_ROS2/commit/661bb9a), [ceb7a7b](https://github.com/hogintosh/PacManBot/commit/ceb7a7b) | [pellet_manager.py](https://github.com/GSandys7/PacManBot_ROS2/blob/main/pacmanbot_package/pacmanbot_package/pellet_manager.py), [planner_stub.py](https://github.com/GSandys7/PacManBot_ROS2/blob/main/pacmanbot_package/pacmanbot_package/planner_stub.py), [game_light_node.py](https://github.com/GSandys7/PacManBot_ROS2/blob/main/pacmanbot_package/pacmanbot_package/game_light_node.py) |
| Abdirahman Aden  | Game Event Logic & Website Integration      | [7365ba9](https://github.com/hogintosh/PacManBot/commit/7365ba9), [7c4152f](https://github.com/GSandys7/PacManBot_ROS2/commit/7c4152f) | [game_event_mapper.py](https://github.com/GSandys7/PacManBot_ROS2/blob/main/pacmanbot_package/pacmanbot_package/game_event_mapper.py) |
